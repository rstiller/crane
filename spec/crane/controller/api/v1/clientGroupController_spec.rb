...
describe 'ClientGroupControllerTest' do
    ...
    context "all groups" do
        ...
        it "no groups available" do
            ...
            Crane::Models::ClientGroup.where.delete
        ...
        it "one group available" do
            ...
            Crane::Models::ClientGroup.where.delete
            group = Crane::Models::ClientGroup.new :name => "group1", :description => "desc"
            group.save
        ...
        it "one group with client" do
            ...
            client = Crane::Models::Client.new :address => "192.168.1.1", :dockerVersion => "0.6.3", :dockerPort => 4243
    ...
    context "new single group" do
        ...
        it "new group with not existing client" do
            ...
            Crane::Models::Client.where.delete
            Crane::Models::ClientGroup.where.delete
    ...
    context "delete group" do
        ...
        it "delete existing group with clients" do
            ...
            expect(Crane::Models::Client.all.size).to eq(1)
