...
function Container(project, build, infrastructure) {
    ...
    this.build = function(callback) {
        ...
        slf.clone(function() {
            ...
            command.log.set('enabled', true);
            command.start(function(data) {
            }, function(data) {
            }, function(code) {
                build.set('successful', code === 0);
                build.addLog(command.log);
                removeDir(folder);
