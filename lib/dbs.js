...
module.exports.MachineGroups = new PouchDB('http://127.0.0.1:5984/machine-groups');
...
module.exports.BuildLogs = new PouchDB('http://127.0.0.1:5984/build-logs');
module.exports.BaseImages = new PouchDB('http://127.0.0.1:5984/base-images');
