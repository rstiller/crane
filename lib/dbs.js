...
saveDesignDoc(basePath, module.exports.DB, 'project');
saveDesignDoc(basePath, module.exports.DB, 'machine');
saveDesignDoc(basePath, module.exports.DB, 'machine-group');
saveDesignDoc(basePath, module.exports.DB, 'base-image');
saveDesignDoc(basePath, module.exports.DB, 'build-command');
saveDesignDoc(basePath, module.exports.DB, 'command-log');
saveDesignDoc(basePath, module.exports.DB, 'command');
